...
A published site is not a finished one:

- **[Adding Projects](04-adding-projects.md)** — add a new project, then publish again
- **[Documentation index](README.md)** — back to all the guides
